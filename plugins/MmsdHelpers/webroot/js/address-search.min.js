...
$("#"+MMSD.addressSearchVars.fieldsPrefix+"line2").val(c.line2),b=c.line1+" "+c.line2,$("#"+MMSD.addressSearchVars.fieldsPrefix+"fullAddress").val(b),$(MMSD.addressSearchVars.fieldDisplay).val(b),$("#residency-info").show(),MMSD.addressSearchVars.modal.modal("hide"),$(MMSD.addressSearchVars.fieldDisplay).trigger("address:usps")):(MMSD.addressSearchVars.failureDiv.hide(),MMSD.addressSearchVars.invalidDiv.show())}).fail(function(b,c){MMSD.main.errorAlert(b,c)});return!0},addressSearchCancel:function(){$.each(["k4",
"es","ms","hs","all"],function(a,b){$.each(["codes","names","ids"],function(c,e){$("#"+MMSD.addressSearchVars.fieldsPrefix+b+"-school-"+e).val("")})});$("#"+MMSD.addressSearchVars.fieldsPrefix+"line1").val("");$("#"+MMSD.addressSearchVars.fieldsPrefix+"line2").val("");$("#"+MMSD.addressSearchVars.fieldsPrefix+"fullAddress").val("");$(MMSD.addressSearchVars.fieldID).val("");$(MMSD.addressSearchVars.fieldDisplay).val("");MMSD.addressSearchVars.modal.modal("hide");$(MMSD.addressSearchVars.fieldDisplay).trigger("address:cancel")},
setDefaultValues:function(){MMSD.addressSearchVars={modal:$("#modal-address-search"),fieldDisplay:"#address-textfield",fieldID:"#addressID",inDistrict:!1,fieldsPrefix:"address-",resultDiv:$("#address-search-results-div"),failureDiv:$("#address-search-failure-div"),notFoundDiv:$("#address-search-notfound-div"),invalidDiv:$("#address-search-invalid-div"),number:$("#addresssearch-number"),prefix:$("#addresssearch-prefix"),street:$("#addresssearch-street"),tag:$("#addresssearch-tag"),apt:$("#addresssearch-apt"),
city:$("#addresssearch-city"),state:$("#addresssearch-state"),zip:$("#addresssearch-zip")}},hideDivs:function(a=!1){MMSD.addressSearchVars.failureDiv.hide();MMSD.addressSearchVars.notFoundDiv.hide();MMSD.addressSearchVars.invalidDiv.hide();a||(MMSD.addressSearchVars.resultDiv.hide(),MMSD.addressSearchVars.resultDiv.children().detach())}};
